...
//            ownPt = mesh_.points()[anchorPointi]; // PoliMi
//            neiPt = mesh_.points()[anchors.otherVertex(anchorPointi)];// PoliMi
...
//            ownPt = mesh_.points()[anchors.otherVertex(anchorPointi)]; // PoliMi
//            neiPt = mesh_.points()[anchorPointi]; // PoliMi
        }
...
:
    hexRef8(mesh, cellLevel, pointLevel, history, level0Edgei),
    is2D_(is2D())
{};
...
:
    hexRef8(mesh, cellLevel, pointLevel, level0Edge),
    is2D_(is2D())
{};
